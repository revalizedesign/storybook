...
export default {
  title: 'Multi-component UX/Tagging',
  parameters: {
    docs: {
      description: {
        component: `**Jonathan:** User-defined labels with overflow (+N). Show max 3 inline, "+ Add tag" in edit mode, lowercase, max 20 chars. Needs to become a standalone reusable component.`,
      },
    },
  },
}
